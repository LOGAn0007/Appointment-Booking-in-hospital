  ...
  return (
    <div>
        ...
        <div className='my-10 flex flex-col md:flex-row gap-12'>
          ...
          <p >Welcome to our website, your trusted partner in managing your healthcare needs conveniently and efficiently.We understand the challenges individuals face when it comes to scheduling doctor appointments and managing their health records.</p>
      ...
      <div className='flex flex-col md:flx-row mb-20'>
